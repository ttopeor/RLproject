'''
Sample Usage:-
python calibration.py --dir calibration_checkerboard/ --square_size 0.027
'''
...
if __name__ == '__main__':
    ...
    ap.add_argument("-w", "--width", type=int, help="Width of checkerboard (default=5)",  default=4)
    ap.add_argument("-t", "--height", type=int, help="Height of checkerboard (default=5)", default=4)
