...
if __name__ == '__main__':
    ...
    while True:
        ...
        output_frame, output_tvec_list = pose_esitmation(frame, aruco_dict_type, k, d)

        print("ID_0:", output_tvec_list[0],"ID_1:", output_tvec_list[1],"ID_2:", output_tvec_list[2],"ID_3:", output_tvec_list[3],"ID_4:", output_tvec_list[4], \
              "ID_5:", output_tvec_list[5],"ID_6:", output_tvec_list[6],"ID_7:", output_tvec_list[7],"ID_8:", output_tvec_list[8],"ID_9:", output_tvec_list[9])
